                    ...
                    <td>
                        ...
                        <table class="row row-2" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff;">
                            <tbody>
                                <tr>
                                    <td>
                                        <table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #00122f; color: #000000; width: 680px;" width="680">
                                            <tbody>
                                                <tr>
                                                            ...
                                                            <tr>
                                                                <td class="pad" style="padding-left:10px;padding-right:10px;">
                                                                    <div style="font-family: Georgia, 'Times New Roman', serif">
                                                                        <div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: Georgia, Times, 'Times New Roman', serif; mso-line-height-alt: 14.399999999999999px; color: #ffffff; line-height: 1.2;">
                                                                            <p style="margin: 0; text-align: center;"><span style="font-size:42px;">We Have a New </span></p>
                                                                            <p style="margin: 0; text-align: center;"><span style="font-size:42px;">Lead From the Website!</span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                ...
                                                <tr>
                                                    <td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; border-left: 0px solid #F0F0F0; border-right: 0px solid #F0F0F0; vertical-align: top; padding-top: 0px; padding-bottom: 0px; border-top: 0px; border-bottom: 0px;">
                                                        <table class="image_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                            <tr>
                                                                <td class="pad" style="padding-left:40px;padding-right:40px;width:100%;padding-top:40px;">
                                                                    <div class="alignment" align="center" style="line-height:10px"><img class="big" src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/549121_530277/Wynn%20Ortho%20lead%20notification.jpg" style="display: block; height: auto; border: 0; width: 600px; max-width: 100%;" width="600"></div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                ...
                                                                <td class="pad" style="padding-bottom:40px;padding-left:40px;padding-right:40px;padding-top:20px;">
                                                                    <div style="font-family: 'Trebuchet MS', Tahoma, sans-serif">
                                                                        <div class="txtTinyMce-wrapper" style="font-size: 12px; mso-line-height-alt: 18px; color: #5d5d5d; line-height: 1.5; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;">
                                                                            ...
                                                                            <p style="margin: 0; mso-line-height-alt: 24px;"><span style="font-size:16px;">We just got a new request from the website.</span></p>
                                                                            <p style="margin: 0; mso-line-height-alt: 18px;">&nbsp;</p>
                                                                            ...
                                                                            <p style="margin: 0; mso-line-height-alt: 24px;"><span style="font-size:16px;">Selected Service: ${service}</span></p>
                                                                            <p style="margin: 0; mso-line-height-alt: 24px;"><span style="font-size:16px;">Message: ${message}</span></p>
                                                                            <p style="margin: 0; mso-line-height-alt: 18px;">&nbsp;</p>
                                                                            <p style="margin: 0; mso-line-height-alt: 24px;"><span style="font-size:16px;">Yours Monarchy team wishes you a great success! </span></p>
                                                                            <p style="margin: 0; mso-line-height-alt: 18px;">&nbsp;</p>
                                                                            <p style="margin: 0; mso-line-height-alt: 24px;"><span style="font-size:16px;">In case you need us remember we are always available at support@monarchy.io.</span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
